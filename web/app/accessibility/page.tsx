...
export const metadata: Metadata = {
  title: "Accessibility Statement — Code Engine",
  description:
    "Code Engine accessibility statement: conformance level, known limitations, and how to report accessibility barriers.",
};
      ...
      <div className="max-w-2xl mx-auto space-y-10">
        ...
        <section aria-labelledby="conformance-heading">
          ...
          <p className="text-surface-300 leading-relaxed">
            We are committed to ensuring Code Engine is accessible to everyone. Our target
        ...
        <section aria-labelledby="tech-heading">
          ...
          <p className="text-surface-300 leading-relaxed">
            Code Engine is built with Next.js and Radix UI primitives. Radix provides
        ...
        <section aria-labelledby="feedback-heading">
          ...
          <a
            href="https://github.com/anthropics/code-engine/issues/new?template=accessibility.md"
