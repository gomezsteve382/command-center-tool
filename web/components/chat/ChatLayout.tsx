...
function KeyboardSetup() {
  ...
  useEffect(() => {
    ...
    const cleanups = [
      ...
      registerCommand({ id: CMD.OPEN_SETTINGS, keys: ["mod+,"], label: "Open settings", description: "Configure Code Engine", category: "Navigation", action: () => storeRef.current.openSettings(), global: true, icon: "Settings" }),
