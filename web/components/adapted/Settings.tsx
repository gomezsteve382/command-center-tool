  ...
  return (
    <div className="space-y-0">
      ...
      <ToggleRow
        id="telemetry"
        label="Telemetry"
        description="Send anonymous usage statistics to improve Code Engine"
...
function ApiTab({
  ...
  return (
    <div className="space-y-0">
      <Row>
        <Label htmlFor="api-url" description="Base URL for the Code Engine API server">API URL</Label>
        <TextInput
          id="api-url"
    ...
    <Dialog.Root open={isOpen} onOpenChange={o => { if (!o) handleClose(); }}>
      <Dialog.Portal>
        ...
        >
          ...
          <p id="settings-desc" className="sr-only">Configure Code Engine web preferences</p>
