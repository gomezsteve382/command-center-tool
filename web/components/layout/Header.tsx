  ...
  return (
    <header className="flex items-center justify-between px-4 py-2.5 border-b border-surface-800 bg-surface-900/50 backdrop-blur-sm">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link
          href="/goatmez"
          className="text-xs bg-surface-800 border border-surface-700 rounded-md px-2 py-1 text-surface-300 hover:text-surface-100 hover:bg-surface-700 transition-colors"
        >
          Goatmez
        </Link>
