...
export function DataSettings() {
  ...
  function exportConversations(format: "json" | "markdown") {
    ...
    if (format === "json") {
      ...
      filename = `code-engine-conversations-${ts}.json`;
    } else {
      content = conversations
        ...
        .join("\n\n====\n\n");
      filename = `code-engine-conversations-${ts}.md`;
    }
  ...
  return (
    <div>
      ...
      <SettingRow
        ...
        description="Help improve Code Engine by sharing anonymous usage data. No conversation content is ever sent."
      >
        <Toggle
      ...
      <div className="mt-6 pt-4 border-t border-surface-800">
        <p className="text-xs text-surface-500">
          All data is stored locally in your browser. Code Engine does not send conversation data
