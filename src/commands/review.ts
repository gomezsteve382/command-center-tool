...
// user triggers, so the description carries "Code Engine on the web" + URL.
const CCR_TERMS_URL = 'https://code.claude.com/docs/en/code-engine-on-the-web'
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in Code Engine on the web. See ${CCR_TERMS_URL}`,
