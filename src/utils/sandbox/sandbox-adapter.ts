...
/**
 * Resolve Code Engine-specific path patterns for sandbox-runtime.
 *
 * Code Engine uses special path prefixes in permission rules:
...
/**
 * Convert Code Engine settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Code Engine started)
...
// scrubbed if they appear after a sandboxed command. See anthropics/code-engine#29316.
 ...
 * bareGitRepoFiles. anthropics/code-engine#29316.
 */
