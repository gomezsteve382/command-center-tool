...
export const MACOS_BUNDLE_ID = 'com.anthropic.code-engine-url-handler'
const APP_NAME = 'Code Engine URL Handler'
const DESKTOP_FILE_NAME = 'code-engine-url-handler.desktop'
const MACOS_APP_NAME = 'Code Engine URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Code Engine Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Code Engine
