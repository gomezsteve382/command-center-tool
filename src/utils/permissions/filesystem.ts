...
// Always ask when Code Engine tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Code Engine for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Code Engine)
