 ...
 * is already inside a carried-over cron context (REPL: queryGuard.end() →
 ...
 * a pass-through lets `getWorkload()` inside `fn` return the carried-over tag.
 * Once carried over, it's sticky forever: every turn's end-notify re-propagates
