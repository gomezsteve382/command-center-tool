/**
 * MDM (Mobile Device Management) profile enforcement for Code Engine managed settings.
 *
 ...
 * - Linux: No MDM equivalent (uses /etc/code-engine/managed-settings.json instead)
 *
