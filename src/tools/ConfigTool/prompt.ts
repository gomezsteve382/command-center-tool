...
export const DESCRIPTION = 'Get or set Code Engine configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Code Engine configuration settings.

  View or change Code Engine settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
