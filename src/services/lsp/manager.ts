 ...
 * Initialized during Code Engine startup.
 */
 ...
 * asynchronously during Code Engine startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during Code Engine startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/anthropics/code-engine/issues/15521:
 ...
 *
 * This should be called during Code Engine shutdown. Stops all running LSP servers
