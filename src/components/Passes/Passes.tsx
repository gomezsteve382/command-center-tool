  ...
  return <Pane>
      <Box flexDirection="column" gap={1}>
        ...
        <Box flexDirection="column" marginLeft={2}>
          <Text dimColor>
            {referrerReward ? `Share a free week of Code Engine with friends. If they love it and subscribe, you'll get ${formatCreditAmount(referrerReward)} of extra usage to keep building. ` : 'Share a free week of Code Engine with friends. '}
            <Link url={referrerReward ? 'https://support.claude.com/en/articles/13456702-code-engine-guest-passes' : 'https://support.claude.com/en/articles/12875061-code-engine-guest-passes'}>
              Terms apply.
            </Link>
          </Text>
        </Box>
