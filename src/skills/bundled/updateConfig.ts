...
\`\`\`
Plugin syntax: \`plugin-name@source\` where source is \`code-engine-marketplace\`, \`claude-plugins-official\`, or \`builtin\`.
...
Hooks run commands at specific points in Code Engine's lifecycle.
...
Modify Code Engine configuration by updating settings.json files.
