...
This repo archives a reference snapshot of SRT Lab's Code Engine CLI. Contributions here are about **documentation, tooling, and exploration aids** — not modifying the original Code Engine source.
...
- **`src/` directory** — This is the original core source. Don't modify it.
- The [`backup` branch](https://github.com/srtlab/code-engine/tree/backup) contains the unmodified original.
...
Open an issue or reach out to [srtlab](https://www.x.com/srtlab).
