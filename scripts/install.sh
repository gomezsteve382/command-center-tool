...
# ─────────────────────────────────────────────────────────────
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/anthropics/code-engine/main/scripts/install.sh | sh
#
# Or with an API key:
...
REPO="https://raw.githubusercontent.com/anthropics/code-engine/main"
