...
> Complete catalog of all slash commands in Code Engine.
...
| Command | Source | Description |
|---------|--------|-------------|
| `/config` | `config/` | View or modify Code Engine settings |
...
| Command | Source | Description |
|---------|--------|-------------|
| `/login` | `login/` | Authenticate with SRT Lab |
...
| `/version` | `version.ts` | Show Code Engine version |
...
| Command | Source | Description |
|---------|--------|-------------|
| `/install` | `install.tsx` | Install or update Code Engine |
...
| `/exit` | `exit/` | Exit Code Engine |
| `/copy` | `copy/` | Copy content to clipboard |
| `/feedback` | `feedback/` | Send feedback to SRT Lab |
...
| Command | Source | Description |
|---------|--------|-------------|
| `/ant-trace` | `ant-trace/` | SRT Lab-internal tracing |
